...
class MeanRevBacktester():
    ...
    def __init__(self, symbol, SMA, dev, start, end, tc,intervala, period):
        self.symbol = symbol
        self.SMA = SMA
        self.dev = dev
        self.start = start
    ...
    def __repr__(self):
        rep = "MeanRevBacktester(symbol = {}, SMA = {}, dev = {}, start = {}, end = {}, interval = {}, period = {))"
        return rep.format(self.symbol, self.SMA, self.dev, self.start, self.end, self.intervala,self.period)
